...
export default function AgbPage() {
  return (
    <LegalPage title="Allgemeine Geschäftsbedingungen">
      ...
      <p>
        Der konkrete Leistungsumfang (Termin, Ort, Dauer, Inhalte) ergibt sich
        aus der jeweiligen Seminarbeschreibung auf der Website zum Zeitpunkt
        der Buchung sowie aus der Buchungsbestätigung. Der Anbieter behält sich
        vor, in begründeten Fällen (z. B. Krankheit, höhere Gewalt) inhaltliche
        oder organisatorische Anpassungen vorzunehmen, soweit diese für den
      ...
      <p>
        ...
        § 355 BGB zu. Das Widerrufsrecht erlischt vorzeitig, wenn der Anbieter
        die Dienstleistung vollständig erbracht hat und der Kunde dem zuvor
        ausdrücklich zugestimmt und gleichzeitig seine Kenntnis vom Erlöschen
        des Widerrufsrechts bestätigt hat (§ 356 Abs. 4 BGB). Der Widerruf ist
        in Textform an die unter Ziffer 2 genannte Adresse zu richten.
      </p>
      ...
      <p>
        ...
        [Datum] — Name, Anschrift, Datum, Unterschrift (nur bei Mitteilung auf
        Papier).
      </p>

      <h2>7. Stornierung und Umbuchung durch den Kunden</h2>
      <p>
        Unabhängig vom Widerrufsrecht gelten für die Stornierung der Teilnahme
        folgende Regelungen:
      </p>
      <ul>
        <li>
          Stornierung bis 14 Tage vor Veranstaltungsbeginn: Rückerstattung des
          gezahlten Entgelts abzüglich einer Bearbeitungspauschale von 15 €.
        </li>
        <li>
      ...
      <h2>8. Absage durch den Anbieter</h2>
      <p>
        ...
        (z. B. Krankheit, höhere Gewalt). In diesem Fall erhält der Kunde das
        gezahlte Entgelt vollständig zurück. Weitergehende Ansprüche, etwa auf
        Erstattung von Reise- oder Übernachtungskosten, bestehen nur bei Vorsatz
        oder grober Fahrlässigkeit des Anbieters.
      </p>

      <h2>9. Pflichten des Kunden</h2>
      <p>
        Die Teilnahme an den Seminaren erfolgt auf eigene Verantwortung. Der
        Kunde versichert, gesundheitlich in der Lage zu sein, an den Inhalten
        teilzunehmen, und etwaige gesundheitliche Risiken vorab mit einem Arzt
        abgeklärt zu haben. Die im Seminar gegebenen Empfehlungen ersetzen
        keine ärztliche oder physiotherapeutische Beratung.
      </p>
      ...
      <h2>11. Urheber- und Nutzungsrechte</h2>
      <p>
        Alle im Rahmen der Seminare ausgegebenen Unterlagen, Texte, Folien und
        Materialien sind urheberrechtlich geschützt. Eine Weitergabe,
        Vervielfältigung oder Veröffentlichung — auch auszugsweise — bedarf der
        vorherigen schriftlichen Zustimmung des Anbieters.
      </p>

      <h2>12. Bild- und Tonaufnahmen</h2>
      <p>
        Eigene Bild- oder Tonaufnahmen während der Veranstaltung sind nur mit
        ausdrücklicher Zustimmung des Anbieters sowie aller davon betroffenen
        Personen zulässig.
      </p>
      ...
      <p>
        ...
        UN-Kaufrechts. Sofern der Kunde Kaufmann, juristische Person des
        öffentlichen Rechts oder öffentlich-rechtliches Sondervermögen ist,
        ist Gerichtsstand für alle Streitigkeiten aus dem Vertragsverhältnis
        Braunschweig. Sollte eine Bestimmung dieser AGB unwirksam sein, bleibt
