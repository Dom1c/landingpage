...
export default function DatenschutzPage() {
  return (
    <LegalPage title="Datenschutzerklärung" updated="Mai 2026">
      ...
      <LegalSection title="2. Allgemeines zur Datenverarbeitung">
        <p>
          ...
          Bereitstellung einer funktionsfähigen Website sowie meiner Inhalte
          und Leistungen erforderlich ist. Die Verarbeitung erfolgt regelmäßig
          nur nach Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), zur
          Vertragserfüllung (lit. b), zur Erfüllung rechtlicher Pflichten (lit.
          c) oder auf Grundlage berechtigter Interessen (lit. f).
        </p>
      </LegalSection>

      <LegalSection title="3. Hosting und Server-Logs">
        <p>
          Diese Website wird bei einem externen Dienstleister gehostet. Beim
          Aufruf der Seite werden technisch notwendige Daten (sog.
          Server-Logs) verarbeitet, insbesondere:
        </p>
        <ul>
      ...
      <LegalSection title="4. Cookies">
        <p>
          Diese Website setzt grundsätzlich nur technisch notwendige Cookies
      ...
      <LegalSection title="5. Terminbuchung über Calendly">
        <p>
          Für die Buchung von Kennenlern-Terminen nutze ich den Dienst{" "}
          <strong>Calendly</strong> der Calendly LLC, 271 17th St NW, Atlanta,
          GA 30363, USA. Beim Aufruf des Calendly-Widgets werden
          personenbezogene Daten (z. B. IP-Adresse, Browserdaten, Eingabedaten
          wie Name und E-Mail-Adresse) an Calendly übermittelt und in den USA
          verarbeitet. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO
          (Vertragsanbahnung) sowie lit. f DSGVO (effiziente
          Terminkoordination).
        </p>
        <p>
      ...
      <LegalSection title="6. Zahlungsabwicklung über Stripe">
        <p>
          ...
          Bezahlvorgang startest, wirst du auf die Stripe-Plattform
          weitergeleitet. Dort eingegebene Zahlungsdaten werden ausschließlich
          durch Stripe verarbeitet. Ich selbst erhalte keine vollständigen
      ...
      <LegalSection title="7. Schriftarten (lokal eingebunden)">
        <p>
          Diese Website verwendet die Schriftarten „Inter Tight&ldquo; und
          „Newsreader&ldquo;. Die Schriften werden über die in Next.js
          integrierte Funktion <code>next/font</code> bereits zum Zeitpunkt des
          Build-Prozesses heruntergeladen und anschließend lokal von meinem
          eigenen Server ausgeliefert. Beim Aufruf der Website wird daher{" "}
      ...
      <LegalSection title="8. Externe Links">
        <p>
          ...
          Google Maps für die Anzeige des Veranstaltungsortes). Diese werden
          erst durch einen aktiven Klick aufgerufen. Eine Übertragung von Daten
          an die jeweiligen Anbieter findet erst statt, wenn du den Link
          nutzt.
        </p>
      </LegalSection>

      <LegalSection title="9. Kontaktaufnahme per E-Mail">
        <p>
          ...
          oder f DSGVO. Die Daten werden gelöscht, sobald sie zur
      ...
      <LegalSection title="10. Deine Rechte">
        ...
        <p>
          ...
          Datenschutz-Aufsichts­behörde zu (Art. 77 DSGVO). Zuständig ist die
          Landesbeauftragte für den Datenschutz Niedersachsen.
        </p>
      </LegalSection>

      <LegalSection title="11. SSL-Verschlüsselung">
        <p>
